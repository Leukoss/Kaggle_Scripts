...
def lightgbm_2012_2018(df_train: pd.DataFrame, df_test: pd.DataFrame) -> pd.DataFrame:
    """
...
def lightgbm_2019_2022(df_train: pd.DataFrame, df_test: pd.DataFrame
                       ) -> pd.DataFrame:
    """
    Permet de réaliser un modèle et de prédire un jeu test
    :param df_train: jeu d'entraînement
...
pred_2012_2018 = lightgbm_2012_2018(train_data_2012_2018, test_data_2012_2018)
pred_2019_2022 = lightgbm_2019_2022(train_data_2019_2022, test_data_2019_2022)
...
pred_2012_2022.to_csv('TEST_EVAL/LGBM_28_04_SCRIPT.csv',
